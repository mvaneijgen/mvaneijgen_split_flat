...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
		...
		MO(_BASE), MO(_BASE), KC_ENT, KC_DEL, KC_BSPC, KC_SPC, MO(_BASE), MO(_BASE)
  ),
  // [_NUMSYM] = LAYOUT(
  ...
  //   KC_TRNS, KC_TRNS, TG(_NUMSYM), KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_EQL
  // ),
  // [_CTRL] = LAYOUT(
  ...
  //   KC_LCTL, KC_LALT, KC_LCMD, KC_SPC, KC_ENT, MO(_BASE), KC_LEFT, KC_DOWN, KC_RIGHT
  // ),
  // [_RESET] = LAYOUT(
  //   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET, 
  //   TG(_GAME), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
